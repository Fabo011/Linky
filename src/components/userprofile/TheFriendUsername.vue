<template>
    <div class="forms-inputs mb-3">
        <span><b>Friend Username</b></span> <mark id="mark-counter">{{ friendUsername.length }}/12</mark> <br />
        <input autocomplete="off" type="text" minlength="4" maxlength="12" class="w-100" v-model="friendUsername"
