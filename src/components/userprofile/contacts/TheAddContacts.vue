<template>
    <section>
        ...
        <i class="text" data-bs-target="#createContactModal" data-bs-toggle="modal"> Create New Contact</i>
        <div class="modal fade" id="createContactModal" tabindex="-1" aria-labelledby="contactModalLabel"
            aria-hidden="true">
